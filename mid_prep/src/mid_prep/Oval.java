...
public class Oval extends Shape{
	public Oval (int x1, int y1, int x2, int y2, boolean filled, boolean gradient, Color color1, Color color2) {
		super(x1, y1, x2, y2, filled, gradient, color1, color2);
	}

	public Oval(int x1, int y1, int x2, int y2,Color color1, Color color2, Color color3) {
	...
	public String toString() {
		return "Oval [x1=" + x1 + ", x2=" + x2 + ", y1=" + y1 + ", y2=" + y2 + ", filled=" + filled + ", gradient="
